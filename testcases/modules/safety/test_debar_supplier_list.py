...
接口: GET /aqserver/zr/debarSupplier/list
"""
import allure
import pytest
...
class TestDebarSupplierList:
    ...
    def test_debar_supplier_list(self, logged_in_api, tc):
        ...
        if filter_field or filter_fields:
            ...
            response = logged_in_api.get_debar_supplier_list(**params)
    ...
    def _run_filter_test(self, api, tc, filter_field, filter_fields):
        ...
        baseline_response = api.get_debar_supplier_list(pageNum=1, pageSize=20)
        ...
        response = api.get_debar_supplier_list(**filter_params)
